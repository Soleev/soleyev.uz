...
(function ( $ ) {
    ...
    $.fn.notifyMe = function( options ) {
        ...
        var settings = $.extend({
			...
			msgErrorValidation: "Ваш e-mail адрес не коректен. Пожалуйста введите адрес Вашей почты.",
			msgErrorFormat: "Ваш e-mail адрес не правильный. Пожалуйста попробуйте заново.",
			msgSuccess: "Успешно! Вы в списке. Мы обязательно проинформируем Вас как только закончим."
		}, options );
